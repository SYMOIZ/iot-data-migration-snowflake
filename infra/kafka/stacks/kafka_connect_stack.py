...
MSK_CLIENT_SG_ID = "<KAFKA_CLIENT_SG_ID>"

# Private IP of the already-running Kafka broker instance (IotHackathon-KafkaBroker).
KAFKA_BROKER_BOOTSTRAP = "<KAFKA_BROKER_PRIVATE_IP>:9092"
...
S3_BACKUP_BUCKET = "iot-hackathon-iot-backup-<AWS_ACCOUNT_ID>-us-east-1"
